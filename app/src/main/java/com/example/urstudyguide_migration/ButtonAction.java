...
import com.example.urstudyguide_migration.Common.AleatoryNumbers;
...
public class ButtonAction {
    ...
    public void buttonAction(final Button actionButton, final String id, final String toppingQuestion, final int numberQuestions, final TextView textView, final Button button1, final Button button2, final Button button3, final Button mainButton, final TextView scoreView){
        actionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                verificadorCounter(button1, button2, button3, textView, mainButton, scoreView, numberQuestions);
    ...
    private void verificadorCounter(Button button1, Button button2, Button button3, TextView textView, Button actionButton, TextView scoreView, int lenght){
        if(counter == lenght){
            aleatoryNumbers.printAllAleatoryNumbers();
            reseatAleatoryNumbers();
            exit(button1, button2, button3, textView, actionButton, scoreView);
        }else{
            counter++;
        }
    }

    private void exit(Button button1, Button button2, Button button3, TextView textView, Button actionButton, TextView scoreView){
